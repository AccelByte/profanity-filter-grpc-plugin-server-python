...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in profanityFilter_pb2_grpc.py depends on'
...
def add_ProfanityFilterServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('accelbyte.profanityfilter.registered.v1.ProfanityFilterService', rpc_method_handlers)
